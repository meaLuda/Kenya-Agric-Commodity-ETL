...
def extract_value_and_unit(value):
    ...
    The regular expression pattern r"(\d+(\.\d+)?)\s*(/?[a-zA-Z]+)?" matches a numeric value followed by an optional unit.
...
# Test the function
print(extract_value_and_unit("80.00/Kg"))
print(extract_value_and_unit("60.00/Kg"))
print(extract_value_and_unit(100))
